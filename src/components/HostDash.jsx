...
const HostDash = () => {
  ...
  return (
    ...
    <p className='ms-4'>Review score <span className='ms-3'><svg width="21" height="19" viewBox="0 0 21 19" fill="none" xmlns="http://www.w3.org/2000/svg">
...
</span> <span>5.0/5</span> <span className='details'>details</span></p>
    </div>
    </>
  )
}
